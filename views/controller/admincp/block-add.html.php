...
{/literal}
{$sCreateJs}
<form method="post" id="js_form" onsubmit="{$sGetJsForm}" class="form" action="{url link="current"}">
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        {/if}
        <input type="hidden" name="val[m_connection]" value="cmlanding.index-visitor"/>
        {if $bIsEdit && $aForms.type_id == 5}
